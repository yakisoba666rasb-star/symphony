...
5. Customize the copied `WORKFLOW.md` file for your project.
   ...
   - For batch landing, add `Approved to Land` as the human approval state and `Landing`
     as the runtime execution state. Keep `landing.execute_enabled` off until the
     dry-run queue display is verified. See [Approved to Land](docs/approved_to_land.md).
...
- [Approved to Land](docs/approved_to_land.md): guarded planner and execution MVP for Linear-approved batch landing.
